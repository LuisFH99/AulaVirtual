<nav class="navbar navbar-expand-md navbar-dark">
    <div class="container-fluid justify-content-center">
        <a class="navbar-brand mr-auto" href="/" style="margin-left: 15px; align-content: center">
            <img src="{{ asset('img/logo-fundasam.png') }}" alt="" width="30"
        ...
        <div class="collapse navbar-collapse container-fluid justify-content-center" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/perfil') }}"><i class="fas fa-user"></i>&nbsp;&nbsp;Mi perfil</a>
                </li>
                {{-- <li class="nav-item">
              <a class="nav-link" href="/cursos"><i class="fa-solid fa-users"></i>&nbsp;&nbsp;Foro &nbsp; </a>
            </li> --}}
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('curso.index') }}"><i
                            class="fa-solid fa-bookmark"></i>&nbsp;&nbsp;Mis cursos</a>
                </li>
            </ul>
            <ul class="navbar-nav mr-auto">
                <li class="dropdown">
                    <a class="nav-link navbar-brand perfil dropdown-toggle" href="#" id="navbarDropdown"
