<div class="col-6 col-md-4 mi_curso_">
    <div class="mi_curso__">
        <div class="imagen">
            <a href="/">
                <img src="https://aula.enppeduca.com/web/images/1645574363-preview.png"
                    alt="">
            </a>
        </div>
        <div class="contentido sombrita">
            <h2><a href="/" class="text-decoration-none card-text">Análisis de datos con
                    Power BI</a></h2>
            ...
            <div class="certificciones">
                <img src="https://aula.enppeduca.com/images/icon-certificacion.png"
                    alt="">
                <p>Certificación <span> 220 horas académicas</span></p>
            </div>
