            ...
            <div class="row">
                ...
                <div class="cursos_ col-md-9">
                    <div class="row">
                        ...
                        @foreach ($docente->docentepublicacion as $publicacion)
                            @if ($aux == 0)
                                    ...
                                    <div class="mi_curso__">
                                        ...
                                        <div class="contentido sombrita">
                                            <h2 class="text-center text-uppercase"><a href="/"
                                                    class="text-decoration-none card-text ">{{ $publicacion->curso->nombre }}</a>
                                            </h2>
                                            <div class="estudiantes">
                                                <img src="https://aula.enppeduca.com/images/icon-estudiantes.png"
                                                    alt="">
                                                <p>{{ count($publicacion->matriculados) }} Estudiantes
                                                </p>
                                            ...
                                            <div class="certificciones">
                                                <img src="https://aula.enppeduca.com/images/icon-certificacion.png"
                                                    alt="">
                                                <p>Certificación <span> {{ $publicacion->horas }} horas
                                                        académicas</span></p>
                                            </div>
                                            <div class="boton"><a
                                                    href="{{ route('docentes.publicacion.index', $publicacion->id) }}"
                                                    class="btn btn-card">Ver Curso</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            @elseif ($publicacion->curso->categoria->nombre == $aux)
                                <div class="col-6 col-md-4 mi_curso_">
                                    <div class="mi_curso__">
                                        <div class="imagen">
                                            <a href="/">
